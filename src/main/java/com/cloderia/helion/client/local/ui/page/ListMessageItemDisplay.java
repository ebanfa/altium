 ...
 * 
 */
@Templated(value = "list-message-page.html#messageListItem")
public class ListMessageItemDisplay extends BaseMessageView implements IsElement {

  	/**
   	 * This element is the root element of this component (as declared in the {@code #message} fragment of the
   	 * {@link Templated#value()} above).
     */
  	@Inject
  	@DataField
  	private TableRow messageListItem;
  	...
  	@Inject 
	TransitionTo<SingleMessagePage> transitionToSinglePage;
